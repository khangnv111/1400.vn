...
namespace W1400.Utility
{
    public sealed class DBCommon
    {
        public static string UrlRoot
        {
            get
            {
                return ConfigurationManager.AppSettings["URL_ROOT"];
            }
        }
        ...
        public static string GetUrlNew(long id, string name)
        {
            string chuoi = "";
            chuoi = string.Format("{0}{1}/{2}/{3}", Config.ApplicationUrl,"tin-tuc", id, StripDiacritics(UCS2Convert(name)));
            return chuoi;
        }
        public static string GetUrlTeam(long id, string name)
        {
            string chuoi = "";
            chuoi = string.Format("{0}{1}/{2}/{3}", Config.ApplicationUrl, "team", id, StripDiacritics(UCS2Convert(name)));
            return chuoi;
        }
        public static string GetUrlMedia(string id, string name) 
        {
            string chuoi = "";
            chuoi = string.Format("{0}{1}/{2}/{3}", Config.ApplicationUrl, "media", id, StripDiacritics(UCS2Convert(name)));
            return chuoi;
        }
