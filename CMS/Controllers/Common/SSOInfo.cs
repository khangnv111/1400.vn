...
namespace CMS.Controllers.Common
{
    public class SSOInfo
    {
        ...
        // ReSharper disable once ParameterHidesMember
        public void SignIn(int _UserId, string _UserName, bool _IsAdministrator, string _SesionID)
        {
            SetCookieUserInfo(_UserId, _UserName, _IsAdministrator, _SesionID);
        }
        ...
        private void SetCookieUserInfo(int UserId, string UserName, bool IsAdministrator, string SessionID)
        {
            string CookieValue = "";
            CookieValue += UserId;
            CookieValue += "|" + UserName;
            ...
            //System.Web.HttpContext.Current.Response.Cookies[_CookieUserInfo].Expires = DateTime.Now.AddMinutes(_LifeTime);
            //System.Web.HttpContext.Current.Response.Cookies[_CookieUserInfo].HttpOnly = true;
            NLogLogger.LogInfo("CookieValue : " + CookieValue);
            FormsAuthentication.SetAuthCookie(rijndaelKey.Encrypt(CookieValue), false);
