...
<script runat="server">
    //private object COOKIE_USERNAME = Lib.Config.GetValue("ssUserName");
    //private object COOKIE_ROLEID = Lib.Config.GetValue("ssUserRole");
	/**
	...
	public override bool CheckAuthentication()
	{
        ...
        //if (COOKIE_USERNAME == null || COOKIE_USERNAME.ToString() == "")
        //{
        //    return false;
        //}
        //else
	...
	public override void SetConfig()
	{
        ...
        BaseUrl = System.Configuration.ConfigurationManager.AppSettings["MediaUrl"];// +"/Content/Upload/"; //System.Configuration.ConfigurationManager.AppSettings["UrlRoot"] + "media/";

		// The phisical directory in the server where the file will end up. If
		// blank, CKFinder attempts to resolve BaseUrl.

        BaseDir = System.Configuration.ConfigurationManager.AppSettings["mediaPath"];//AppDomain.CurrentDomain.BaseDirectory + "..\\CF_POSM.CMS\\Content\\Upload\\";//System.Configuration.ConfigurationManager.AppSettings["MEDIA_DISK"]; 
